...
import {
  manualEntrySchema,
  type CreateManualEntrySchema,
  type ManualEntryProductSchema,
...
export default function ManualEntryForm() {
  ...
  const [produtos, setProdutos] = React.useState<ManualEntryProductSchema[]>([]);
  ...
  const addProduct = () => {
    const newProduct: ManualEntryProductSchema = {
  ...
  const updateProduct = (index: number, field: keyof ManualEntryProductSchema, value: any) => {
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <Input placeholder="Condição de Pagto" {...register('condicaoPagamento')} />
