// app/product-orderStatus/components/form/delete-product-orderStatus-form.tsx
...
import { useDeleteOrderStatus } from '../../api/use-delete-product-orderStatus';

const formSchema = z.object({
  orderStatusId: z.string(),
});

export default function DeleteOrderStatusForm({
  orderStatusId,
  setIsOpen,
}: {
  ...
  const { mutate: deleteOrderStatus, isPending } = useDeleteOrderStatus();
